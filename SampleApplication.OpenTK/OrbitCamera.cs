...
//        {
//            var Eye = new Vector4(0, dist, 0, 1) * Matrix4.CreateRotationZ(angleY) * Matrix4.CreateRotationX(angleX); //*Matrix4.CreateTranslation(lookAt);
